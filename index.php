...
<body>
    ...
    <div class="topBar gradientBlack">
        ...
        <div class="pageControls">
            ...
            <i class="APIError fa fa-exclamation-triangle" title="There was a problem acquiring data from the API"></i>
            ...
            <div class="searchHugger"><input class="searchBox" type="search" placeholder="Search rockets and payloads">
            <!--<div class="searchClear"><i class="searchClear fa fa-close"></i></div>-->
            </div>
            ...
            <span class="controlButton betaButton fakeLink" title="View the beta page"><a href="./beta/"><i class="fa fa-flask"></i></a></span>
            <span class="controlButton changesButton fakeLink" title="View recent database changes"><a href="./changes/"><i class="fa fa-database"></i></a></span>
            <i class="controlButton playPause fa fa-pause fakeLink" title="Pause or resume page updates"></i>
